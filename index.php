...
<body>
    <section class="container-fluid custom__px-main custom__py-main bg-main pos-rel">
        <div class="row index-1">
            <div class="d-md-none mx-auto">
                <img src="./assets/images/logo.png" alt="Logo" class="logo d-flex mx-auto" />
            ...
            <aside class="col-8 offset-2 col-md-6 offset-md-0 col-lg-6 col-xl-5 offset-xl-1 justify-content-center pl-5 order-1 order-md-2 mt-4 mt-md-5 mt-lg-0 phone pos-rel">
                <div class="d-flex wow animate__fadeInDown" data-wow-duration="1s">
                    <div class="pos-rel">
                        ...
                        <img src="./assets/images/frame.png" class="off" alt="">
                    </div>
                </div>
                <img src="./assets/images/back.png" alt="" class="back animate__animated wow animate__fadeInUp animate__delay-1s" data-wow-duration="1s">
            </aside>
        </div>
    ...
    <section class="container-fluid custom__px-main mt-rev">
        <div class="row features py-md-4 py-lg-5 py-2">
            ...
            <section class="col-12 col-md-4 my-3 my-md-0 px-5 px-md-2 text-center wow animate__flipInY" data-wow-duration="1s">
                <img src="./assets/images/detect.png" alt="" class="d-block mx-auto">
            ...
            <section class="col-12 col-md-4 my-3 my-md-0 px-5 px-md-2 text-center wow animate__flipInY" data-wow-duration="1s">
                <img src="./assets/images/solution.png" alt="" class="d-block mx-auto">
    ...
    <section class="container">
        <div class="row">
            <div class="col-6 col-md-4 px-4 mb-5 wow animate__flipInY" data-wow-duration="2s">
                <h6 class="font-weight-bold text-center mb-md-4">Home Screen</h6>
                <div class="d-flex justify-content-center">
                    <img src="./assets/images/screen1.png" class="img-fluid" id="modal__img" alt="">
                </div>
            </div>
            <div class="col-6 col-md-4 px-4 mb-5 wow animate__flipInY" data-wow-duration="2s">
                <h6 class="font-weight-bold text-center mb-md-4">Recording Screen</h6>
                <div class="d-flex justify-content-center">
                    <img src="./assets/images/screen2.png" class="img-fluid" id="modal__img" alt="">
                </div>
            </div>
            <div class="col-6 col-md-4 px-4 mb-5 wow animate__flipInY" data-wow-duration="2s">
                <h6 class="font-weight-bold text-center mb-md-4">Analyzing Screen</h6>
                <div class="d-flex justify-content-center">
                    <img src="./assets/images/screen3.png" class="img-fluid" id="modal__img" alt="">
                </div>
            </div>
            <div class="col-6 col-md-4 px-4 mb-5 wow animate__flipInY" data-wow-duration="2s">
                <h6 class="font-weight-bold text-center mb-md-4">Analysis Report Screen</h6>
                <div class="d-flex justify-content-center">
                    <img src="./assets/images/screen4.png" class="img-fluid" id="modal__img" alt="">
                </div>
            </div>
            <div class="col-6 col-md-4 px-4 mb-5 wow animate__flipInY" data-wow-duration="2s">
                <h6 class="font-weight-bold text-center mb-md-4">Team Screen</h6>
                <div class="d-flex justify-content-center">
                    <img src="./assets/images/screen5.png" class="img-fluid" id="modal__img" alt="">
                </div>
            </div>
            <div class="col-6 col-md-4 px-4 mb-5 wow animate__flipInY" data-wow-duration="2s">
                <h6 class="font-weight-bold text-center mb-md-4">Player Stats Screen</h6>
                <div class="d-flex justify-content-center">
                    <img src="./assets/images/screen6.png" class="img-fluid" id="modal__img" alt="">
                </div>
            </div>
        </div>
    </section>
    <footer class="container-fluid custom__bg-dark pt-5 pb-3">
        <div class="row flex-column justify-content-center">
            <img src="./assets/images/logo.png" alt="Logo" class="logo d-flex mx-auto" />
            <p class="small text-center text-light my-2 my-md-3">&copy; 2020 Privacy &mdash; Terms</p>
        </div>
    </footer>
    <div class="modal__block" id="modal__block">
        <p class="close">X</p>
        <div class="col-8 col-sm-6 col-md-5 col-lg-4 col-xl-3">
            <img id='mod__img' src="./assets/images/back.png" class="w-100" alt="">
        </div>
    </div>
